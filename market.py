...
def get_product_list(page, campaign_id, access_token):
    ...
    Возвращает:
        list: Список продуктов, содержащий информацию о товарах.
...
def update_stocks(stocks, campaign_id, access_token):
    ...
    Возвращает:
        dict: Ответ сервера, содержащий информацию об обновленных остатках.
...
def update_price(prices, campaign_id, access_token):
    ...
    Возвращает:
        dict: Ответ сервера, содержащий информацию об обновленных ценах.
